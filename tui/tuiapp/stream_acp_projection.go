...
func (m *Model) handleMainACPProjection(msg ACPProjectionMsg) (tea.Model, tea.Cmd) {
...
func (m *Model) handleParticipantACPProjection(msg ACPProjectionMsg) (tea.Model, tea.Cmd) {
...
func (m *Model) handleSubagentACPProjection(msg ACPProjectionMsg) (tea.Model, tea.Cmd) {
