...
func (b *BashPanelBlock) shouldShowScrollbar(now time.Time) bool {
...
func (m *Model) touchScrollbarTarget(target scrollbarHitTarget) tea.Cmd {
	...
	case scrollbarTargetBashPanel, scrollbarTargetSubagentPanel:
...
func panelScrollbarKind(block panelScrollbarBlock) scrollbarTargetKind {
	switch block.(type) {
	case *BashPanelBlock:
		return scrollbarTargetBashPanel
